...
import com.example.garbagesorting.utils.clusterutil.projection.Bounds;
...
import com.example.garbagesorting.utils.clusterutil.quadtree.PointQuadTree;
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.example.garbagesorting.utils.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.example.garbagesorting.utils.clusterutil.clustering.algo
