...
package com.example.garbagesorting.utils.clusterutil.clustering.view;
...
import com.example.garbagesorting.utils.clusterutil.clustering.ClusterManager;
import com.example.garbagesorting.utils.clusterutil.projection.Point;
import com.example.garbagesorting.utils.clusterutil.projection.SphericalMercatorProjection;
import com.example.garbagesorting.utils.clusterutil.ui.IconGenerator;
...
import static com.example.garbagesorting.utils.clusterutil.MarkerManager.MAX_DISTANCE_AT_ZOOM;

/**
 * The default view for a ClusterManager. Markers are animated in and out of clusters.
 */
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.example.garbagesorting.utils.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private com.example.garbagesorting.utils.clusterutil.ui.SquareTextView makeSquareTextView(
            Context context) {
        com.example.garbagesorting.utils.clusterutil.ui.SquareTextView squareTextView =
                new com.example.garbagesorting.utils.clusterutil.ui.SquareTextView(context);
