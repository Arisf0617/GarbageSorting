 ...
 */
package com.example.garbagesorting.utils.clusterutil.projection;
...
public class SphericalMercatorProjection {
    ...
    public LatLng toLatLng(com.example.garbagesorting.utils.clusterutil.projection.Point point) {
